...
import tasks.VistaPrincipal.SeleccionarCategoria;
...
public class CasosSteps {
    ...
    public void realizaUnaBúsquedaDeZapatillaDeportiva(String categoria) {
        /*theActorInTheSpotlight().wasAbleTo(
                BuscarArticulo.conDescripcion(articulo)

        );*/
        theActorInTheSpotlight().wasAbleTo(
                SeleccionarCategoria.conTitulo("Mercado")
